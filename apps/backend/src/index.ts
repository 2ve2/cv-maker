 ...
 */
app.use('*', cors({
  origin: ['https://cv.bdalrhmnmtwq53.workers.dev', 'https://cv-maker-2cl.pages.dev', 'http://localhost:3000', 'http://localhost:5173', 'http://192.168.8.173:5174', 'http://192.168.8.173:5176', 'http://192.168.8.173:5173'],
